                ...
                <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="card mb-1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-4 pb-2">
                                <h5 class="card-title text-center pb-0 fs-4 text-dark">Nueva contraseña</h5>
                                <p class="text-center small text-danger">Ingresa tu nueva contraseña.</p>
                            </div>
                            ...
                            <form action="{{ route('password.update') }}" method="post" class="row g-3 needs-validation"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="email"
                                        value="{{ $_REQUEST['email'] }}" readonly>
                                </div>
                                <div class="col-12">
                                    <label for="password" class="form-label">Nueva contraseña</label>
                                    <div class="input-group has-validation">
                                        <input type="password" name="password" placeholder="Ingrese nueva clave"
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary w-100" type="submit">Actualizar clave</button>
                                </div>
