                                ...
                                <form action="{{ route('admin.grupos.update', $grupo->id) }}" method="post"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="text" name="codigo" class="form-control fs-5 text-danger"
                                                id="yourUsername" value="{{ $grupo->codigo }}" readonly required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="nombre" class="form-control" id="yourUsername"
                                            placeholder="Ingrese nombre del grupo de estudio" value="{{ $grupo->nombre }}"
                                            required>
                                            ...
                                            @foreach ($profesores as $profesor)
                                                @if ($grupo->cedula_profesor == $profesor->cedula)
                                                    <option value="{{ $profesor->cedula }}" selected>
                                                        {{ $profesor->cedula }} - {{ $profesor->nombre }}</option>
                                                @endif
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="time" name="hora_inicio" class="form-control" id="yourUsername"
                                            ...
                                            value="{{ $grupo->hora_inicio }}" required>
                                        ...
                                        @foreach ($dias as $dia)
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="{{ $dia['dia'] }}"
                                                    name="dif_{{ $dia['dia'] }}" value="{{ $dia['dia'] }}"
                                                    {{ $dia['activo'] ?? null }}>
                                                <label class="form-check-label"
                                                    for="{{ $dia['dia'] }}">{{ $dia['dia'] }}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="date" name="fecha_inicio" class="form-control" id="yourUsername"
                                            ...
                                            value="{{ $grupo->fecha_inicio }}" required>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="date" name="fecha_fin" class="form-control" id="yourUsername"
                                            ...
                                            value="{{ $grupo->fecha_fin }}" required>
