...
<button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#modalRegistrarcuenta">
    <i class="bi bi-bank"></i> Crear cuenta bancaria
</button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-start">
                <form action="{{ route('admin.cuentas.store') }}" method="post" class="row g-3 needs-validation "
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" name="codigo_banco" class="form-control" id="codigo_banco"
                                ...
                                value="{{ old('codigo_banco') ?? '' }}" required>
                            <div class="invalid-feedback">Por favor, ingrese código del banco! </div>
                        </div>
                        @error('codigo_banco')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" name="nombre_banco" class="form-control" id="nombre_banco"
                                placeholder="Ingrese nombre del banco" value="{{ old('nombre_banco') ?? '' }}" required>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" name="titular" class="form-control" id="titular"
                                placeholder="Ingrese nombre del titular" value="{{ old('titular') ?? '' }}" required>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" name="numero_cuenta" class="form-control" id="numero_cuenta"
                                placeholder="Ingrese número de cuenta" value="{{ old('numero_cuenta') ?? '' }}">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" name="telefono" class="form-control" id="telefono"
                                placeholder="Ingrese número de cuenta" value="{{ old('telefono') ?? '' }}">
                            <div class="invalid-feedback">Por favor, ingrese numero cuenta de la cuenta! </div>
                        </div>
                        @error('telefono')
                            <div class="text-danger">{{ $message }}</div>
