    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-sm-4 col-xs-12 ">
                ...
                @include('admin.medidas.partials.modal-form-create')
            </div>

            <!-- Filtro de medidas -->
            <div class="col-sm-8 col-xs-12">
                <form action="{{ route('admin.medidas.index') }}" method="post">
                    @csrf
                    @method('GET')
            ...
            <div class="col-lg-12 table-responsive">
                ...
                <table class="table table-hover  bg-white mt-2">
                    ...
                    <tbody>
                        ...
                        @foreach ($medidas as $key => $medida)
                            <tr>
                                <th scope="row">{{ ($medidas->currentPage() - 1) * $medidas->perPage() + $key + 1 }}</th>
                                <td>{{ $medida->nombre }}</td>
                                <td>{{ $medida->simbolo }}</td>
                                <td>
                                    @include('admin.medidas.partials.modal-form-edit')
                                    @include('admin.medidas.partials.modal-delete')
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td colspan="4" class="text-center table-secondary">
                                Total de medidas: {{ $medidas->total() }} |
                                <a href="{{ route('admin.medidas.index') }}" class="text-primary">
                                    Ver todo
                                </a>
                                <br>
                            </td>
                ...
                <div class="col-sm-6 col-xs-12">
                    {{ $medidas->appends(['filtro' => $request->filtro, 'limit' => $request->limit])->links() }}
                </div>
                <!-- Fin Paginación -->
